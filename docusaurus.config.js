...
media-src 'self';
form-action 'self';
connect-src 'self' ${POSTHOG_API} https://*.google.com https://cdn.jsdelivr.net https://node.mainnet.etherlink.com https://node.shadownet.etherlink.com https://*.thirdweb.com https://*.algolia.net https://*.algolianet.com https://app.pushfeedback.com https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com https://*.walletconnect.com https://*.walletconnect.org wss://relay.walletconnect.org wss://app.biel.ai https://app.biel.ai;
