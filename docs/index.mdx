...
And it's getting even faster with [Instant Confirmations](/building-on-etherlink/transactions#getting-instant-confirmations), currently an experimental feature, that provide pre-confirmations within 50ms.
