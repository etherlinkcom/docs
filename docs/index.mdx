...
It is a permissionless network that users can run transactions on and deploy smart contracts to.
It has independent governance, built-in MEV protection, and many other features for developers.
...
**Etherlink has sub-second block confirmation times for a snappy experience**. The Tezos 2-block finality guarantee and the speed of its Smart Rollups ensure that transactions are finalized quickly.
