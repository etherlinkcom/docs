...
1. The sequencer creates a corresponding transaction on Etherlink for a precompiled contract to transfer the tez from the [zero address](https://explorer.etherlink.com/address/0x0000000000000000000000000000000000000000) to the user's address.
