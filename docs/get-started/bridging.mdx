...
- A bridge contract that stores information about how many tokens different accounts have bridged to Etherlink
...
1. The exchanger contract sends the ticket to the bridge contract.
1. The bridge contract forwards the ticket to the Etherlink Smart Rollup, which uses the information in the ticket to mint tokens on Etherlink and send them to the user's Etherlink address.
