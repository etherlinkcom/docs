...
1. Etherlink Smart Rollup nodes receive the deposit request from the Smart Rollup inbox.
1. The Smart Rollup nodes create a corresponding transaction on Etherlink to transfer the tez from the [zero address](https://explorer.etherlink.com/address/0x0000000000000000000000000000000000000000) to the user's address.
