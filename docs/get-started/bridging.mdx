...
1. The Etherlink Smart Rollup receives the deposit request from the Smart Rollup inbox.
1. The Etherlink Smart rollup creates a corresponding transaction on Etherlink to transfer the tez from the [zero address](https://explorer.etherlink.com/address/0x0000000000000000000000000000000000000000) to the user's address.
