...
- The Etherlink installer kernel (`installer.hex` file), which you can build yourself or download as described in [Building the Etherlink kernel](#building-the-etherlink-kernel)
