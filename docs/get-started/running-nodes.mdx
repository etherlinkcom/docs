...
- Octez does not yet provide a binary build of the Etherlink node as part of its binary distribution or in the `tezos/tezos` docker image, but you can get it from the `tezos/tezos-bare` image if you use a specific tag.
