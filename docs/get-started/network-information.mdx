...
However, this test work will be decommissioned at the end of December 2025 and the Shadownet test network will be the primary Etherlink test network.
...
<table class="customTableContainer">
  ...
  <tbody>
    ...
    <tr>
      <td>RPC Endpoint</td>
      <td><InlineCopy code="https://node.braeburn.etherlink.com" /></td>
    </tr>
    <tr>
      <td>Websocket Endpoint</td>
      <td>Not yet publicly available; see <a href="/building-on-etherlink/websockets">Getting updates with WebSockets</a></td>
    ...
    <tr>
      <td>Relay Endpoint</td>
      <td><InlineCopy code="https://relay.braeburn.etherlink.com" /></td>
    </tr>
    <tr>
      <td>Tezos Smart Rollup address</td>
    ...
    <tr>
      <td>Block Explorer URL</td>
      <td><a href="https://braeburn.explorer.etherlink.com">https://braeburn.explorer.etherlink.com</a></td>
    </tr>
    <tr>
      <td>Etherlink smart rollup snapshots</td>
    ...
    <tr>
      <td>Etherlink EVM node snapshots</td>
      <td><a href="https://snapshotter-sandbox.nomadic-labs.eu/etherlink-shadownet/">https://snapshotter-sandbox.nomadic-labs.eu/etherlink-shadownet/</a></td>
    </tr>
    <tr>
      <td>Pre-images</td>
