...
This test network (sometimes abbreviated as "Shadownet Testnet" in the Etherlink jargon) runs on the [Shadownet](https://teztnets.com/shadownet-about) Tezos test network.
...
<table class="customTableContainer">
  ...
  <tbody>
    ...
    <tr>
      <td>RPC Endpoint</td>
      <td><InlineCopy code="https://node.shadownet.etherlink.com" />(coming soon!)</td>
    </tr>
    <tr>
      <td>Websocket Endpoint</td>
      <td>coming soon: see <a href="/building-on-etherlink/websockets">Getting updates with WebSockets</a></td>
    </tr>
    <tr>
      <td>Relay Endpoint</td>
      <td><InlineCopy code="https://relay.shadownet.etherlink.com" />(coming soon!)</td>
    </tr>
    <tr>
      <td>Tezos Smart Rollup address</td>
    ...
    <tr>
      <td>Etherlink EVM node snapshots</td>
      <td><a href="https://snapshotter-sandbox.nomadic-labs.eu/etherlink-shadownet/">https://snapshotter-sandbox.nomadic-labs.eu/etherlink-shadownet/</a> (coming soon)</td>
    </tr>
    <tr>
      <td>Pre-images</td>
      <td><a href="https://snapshots.tzinit.org/etherlink-shadownet/wasm_2_0_0">https://snapshots.tzinit.org/etherlink-shadownet/wasm_2_0_0</a> (coming soon)</td>
    </tr>
    <tr>
      <td>Genesis date</td>
