...
Fee structure | Variable, including an execution fee and a fee for data inclusion on layer 1 but not a voluntary tip; see [Estimating fees](/building-on-etherlink/fees)
