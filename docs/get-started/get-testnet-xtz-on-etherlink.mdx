...
If you have tez (XTZ) on the Tezos Ghostnet network or get some from the [Ghostnet Faucet](https://faucet.ghostnet.teztnets.com/), you can bridge them to Etherlink XTZ by using the bridge at https://bridge.etherlink.com/.
:::
