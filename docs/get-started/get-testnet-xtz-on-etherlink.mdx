...
If you have tez on the Tezos Ghostnet network or get some from the [Ghostnet Faucet](https://faucet.ghostnet.teztnets.com/), you can bridge them to Etherlink ETH by using the bridge at https://bridge.etherlink-nightly.tzalpha.net/.
:::
