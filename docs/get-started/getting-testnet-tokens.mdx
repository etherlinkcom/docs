...
You can also get testnet XTZ on Tezos testnet and bridge them to Etherlink Testnet, as described in [Bridging tokens](/building-on-etherlink/bridging-layer1).
