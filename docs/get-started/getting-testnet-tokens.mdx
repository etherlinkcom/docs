...
To get tokens on Etherlink Ghostnet Testnet, follow these steps:
...
If you need more tokens, the [Tezos testnet faucet](https://faucet.ghostnet.teztnets.com/) provides more XTZ.
