...
<TabItem value="layerzero" label="Layer Zero Shadownet Testnet wrapped asset bridge">

Layer Zero uses these contracts to operate the wrapped asset bridge on Shadownet testnet.
