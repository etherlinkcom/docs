...
The bridge relies on these LayerZero contracts for security, as well as the Etherlink node operators that secure Etherlink itself, who are listed in [Network operators](/network/operators).
