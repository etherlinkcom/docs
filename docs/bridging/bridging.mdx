...
- [Bridging XTZ between Tezos layer 1 and Etherlink](/bridging/bridging-xtz)
- [Bridging tokens between Etherlink and other EVM networks](/bridging/bridging-wrapped-assets) such as Ethereum, Avalanche, Arbitrum One, Optimism, Base, and BNB Chain
