---
title: Indexing Etherlink EVM contracts with The Graph # tevm
...
3. Initialize your subgraph⁠
    ...
    Simply have your contract [verified on the block explorer](/evm/developing/verifying-contracts) and the CLI will automatically obtain the ABI and set up your subgraph. The default settings will generate an entity for each event. 
