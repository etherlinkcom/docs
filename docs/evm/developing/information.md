---
title: Getting information about Etherlink # tx
dependencies:
  ethers: 6.13.5
---
...
- For a list of endpoints that the EVM interface supports, see [Ethereum endpoint support](/evm/developing/endpoint-support)
...
For even more information about transactions and blocks, see [Tracing transactions](/evm/developing/transactions#tracing-transactions).

## Using ethers.js

Similarly, you can use [ethers.js](https://docs.ethers.org/v6/) to get information about Etherlink EVM<!--TEVM-->.
This example uses ethers.js to get information about Etherlink EVM<!--TEVM-->, including the current block number, an account balance, and information about a block and a transaction:
