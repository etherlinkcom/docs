...
[Pyth](https://pyth.network/) offers 400+ pull-based price feeds for Etherlink EVM<!--TEVM-->.
...
To deploy this contract you need the address of the Pyth on-chain application on Etherlink EVM<!--TEVM--> (`0x2880aB155794e7179c9eE2e38200202908C17B43` on Mainnet and Shadownet Testnet) and the ID of the XTZ/USD price feed (`0x0affd4b8ad136a21d79bc82450a325ee12ff55a235abc242666e423b8bcffd03` as listed on the Pyth [Price feed IDs](https://legacy.pyth.network/developers/price-feed-ids)).

Here is an example JavaScript application that uses the [`viem`](https://viem.sh/) SDK to call the contract on Etherlink EVM<!--TEVM-->:
...
[RedStone](https://redstone.finance/) offers push-based price feeds for Etherlink EVM<!--TEVM-->.
...
- `0xe92c00BC72dD12e26E61212c04E8D93aa09624F2` on Etherlink<!--TX--> Mainnet
- `0xb9D0073aCb296719C26a8BF156e4b599174fe1d5` on Etherlink<!--TX--> Shadownet Testnet

Similarly, you can get the price of the URANIUM token in USD with these addresses:

- `0xb81131B6368b3F0a83af09dB4E39Ac23DA96C2Db` on Etherlink<!--TX--> Mainnet
- `0xED2B1ca5D7E246f615c2291De309643D41FeC97e` on Etherlink<!--TX--> Shadownet Testnet
...
To deploy this contract you need the address of the Acelon proxy on Etherlink EVM<!--TEVM--> (`0x4Bf5C46Ee59a1110c2a242715f9c3b548A14ee02` on Mainnet).
Acelon is not available on Etherlink<!--TX--> testnets.

Here is an example JavaScript application that uses the [`viem`](https://viem.sh/) SDK to get the price of stXTZ on Etherlink EVM<!--TEVM-->:
