...
[Etherlink Safe](https://safe.etherlink.com) is a Etherlink EVM<!--TEVM--> implementation of [Safe\{Wallet\}](https://github.com/safe-global/safe-wallet-web), which manages multi-signature smart contracts (multisigs).
