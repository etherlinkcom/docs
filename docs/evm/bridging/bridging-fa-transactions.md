...
1. When the deposit is in a Etherlink EVM<!--TEVM--> block, call the FA bridging precompiled contract contract's `claim` function to cause the ERC-20 proxy contract to mint the tokens.
