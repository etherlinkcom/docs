...
Etherlink developers have created these bridges.
...
Bridge type | Description | Mainnet link | Testnet link
--- | --- | --- | ---
...
Wrapped asset bridge | Bridges assets from EVM chains to wrapped assets on Etherlink and back | TODO | TODO
...
## Bridging tez (XTZ) between Tezos layer 1 and Etherlink
