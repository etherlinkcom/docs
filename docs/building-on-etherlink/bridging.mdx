...
- [Bridging tokens between Etherlink and other EVM networks](./bridging-wrapped-assets)
- [Bridging FA tokens between Tezos layer 1 and Etherlink](./bridging-fa)
...
Financial asset bridge | Bridges FA1.2 and FA2 [standards-compliant tokens](https://docs.tezos.com/architecture/tokens) from Tezos layer 1 to Etherlink and back | See [Bridging FA tokens between Tezos layer 1 and Etherlink](./bridging-fa) | See [Bridging FA tokens between Tezos layer 1 and Etherlink](./bridging-fa)
