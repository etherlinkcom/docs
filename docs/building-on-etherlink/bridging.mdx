...
- [Bridging FA tokens between Tezos layer 1 and Etherlink](/building-on-etherlink/bridging-fa)
...
<table class="customTableContainer">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>See [Bridging FA tokens between Tezos layer 1 and Etherlink](/building-on-etherlink/bridging-fa)</td>
      <td>See [Bridging FA tokens between Tezos layer 1 and Etherlink](/building-on-etherlink/bridging-fa)</td>
    </tr>
  </tbody>
</table>
