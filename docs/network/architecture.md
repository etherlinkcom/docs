...
![A high-level diagram of the Etherlink<!--TX--> architecture, showing the interaction between the nodes and the sequencer](/img/architecture-high-level.png)
...
![A more detailed diagram of Etherlink<!--TX--> architecture, showing the flow of transactions and blocks](/img/architecture-full.png)
