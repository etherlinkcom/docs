...
If you switch the node to a mode that stores less data, it reduces the size of the data directory the next time that the node runs internal garbage collection, within 24 hours.
