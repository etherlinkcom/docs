---
title: Building the Etherlink kernel # tx
dependencies:
  octez: 0
---
...
You can set the `pre-images-endpoint` field in the Smart Rollup node's configuration file as described in [Running a Etherlink{/* TX */} Smart Rollup node](/network/smart-rollup-nodes).
