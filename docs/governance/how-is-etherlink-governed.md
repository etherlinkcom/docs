...
This table shows the period lengths as of Etherlink 6.3 and the Tezos Tallinn protocol:
...
As of Etherlink 6.3, the leading proposal must gather support from at least 1% of the total voting power to move to the next phase.
...
This table shows the requirements as of Etherlink 6.3:
