...
```bash
octez-client call KT1AXRU3wLc87WNhLhVGrgqDGubLACUMUgPb from my_wallet \
...
- The address of the Etherlink<!--TX--> kernel governance contract, either the slow governance contract or the fast governance contract; see [Governance contract addresses](/governance/overview#governance-contract-addresses)
