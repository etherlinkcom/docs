...
During a Proposal period, go to the [governance web site](https://governance.etherlink.com) and find the hash of the kernel to upvote.
...
- `<KERNEL_HASH>`: The hash of the kernel to upvote
