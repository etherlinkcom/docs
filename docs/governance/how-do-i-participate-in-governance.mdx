...
To remove the delegation from your voting key, you can just call the claim entrypoint:
...
```
Please note that if you're already delegating to this key and just want to change your delegation, you don't need to claim again.
