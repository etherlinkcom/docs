...
By default, when you delegate your baking key to another key, that key receives the rights to vote for each governance contract.
For example, the following command delegates voting rights for each governance contract from the key with the alias `my_wallet`.
...
```bash
octez-client transfer 0 from my_wallet to KT1Ut6kfrTV9tK967tDYgQPMvy9t578iN7iH \
  --arg "(Pair \"tz1QCVQinE8iVj1H2fckqx6oiM85CNJSK9Sx\" True (Some { \"KT1WckZ2uiLfHCfQyNp1mtqeRcC1X6Jg2Qzf\" ; \"KT1VZVNCNnhUp7s15d9RsdycP7C1iwYhAQ8r\" }))"
```
...
```bash
octez-client transfer 0 from my_wallet to KT1Ut6kfrTV9tK967tDYgQPMvy9t578iN7iH --arg "(Pair \"tz1QCVQinE8iVj1H2fckqx6oiM85CNJSK9Sx\" False (Some { \"KT1QDgF5pBkXEizj5RnmagEyxLxMTwVRpmYk\" }))" --burn-cap 1
```
