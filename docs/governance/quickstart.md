...
- `<GOVERNANCE_CONTRACT>`: The governance contract to call, either `KT1AXRU3wLc87WNhLhVGrgqDGubLACUMUgPb` for the slow governance process or `KT19oUVQPnVLuUBYXrBVd46WJnNAMpqkKSwo` for the fast governance process; see [Governance contract addresses](/governance/overview#governance-contract-addresses)
